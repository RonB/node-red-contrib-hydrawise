# Contributing to node-red-contrib-hydrawise

As in Node-RED we have some guidelines for the hydrawise contribution package.
...
At a minimum, please include:
 ...
 - Version of node-red-contrib-hydrawise?
 
 - What is your platform? (Linux, macOS, ...)
 - What does `DEBUG=hydrawise:* node-red -v` say? (log files are welcome)
